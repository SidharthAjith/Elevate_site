                    ...
                    <div className="col-xxl-8 col-lg-7">
                        <div className="blog-single-card">
                            <div className="blog-thumb">
                                <img src="assets/img/blog/blog_s2_1.png" alt="Elevate" />
                            ...
                            <div className="blog-content">
                                ...
                                <Link to="/blog-details" className="global-btn style-border2">
                                    {" "}
                                    Read More <img src="assets/img/icon/right-icon2.svg" alt="Elevate" />
                                </Link>
                            </div>
                        </div>
                        <div className="blog-single-card">
                            <div className="blog-thumb">
                                <img src="assets/img/blog/blog_s2_2.png" alt="Elevate" />
                                <div className="blog-date">
                                    <Link to="/blog">
                                        <span>31</span>May
                                    </Link>
                        ...
                        <div className="blog-single-card">
                            <div className="blog-thumb">
                                <img src="assets/img/blog/blog_s2_3.png" alt="Elevate" />
                                <div className="blog-date">
                                    <Link to="/blog">
                                        <span>31</span>May
                                    </Link>
                                ...
                                <ul>
                                    <li>
                                        <Link to="/blog">
                                            ...
                                            <img src="assets/img/icon/category-1.svg" alt="Elevate" />
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/blog">
                                            Digital Transformation
                                            <img src="assets/img/icon/category-2.svg" alt="Elevate" />
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/blog">
                                            Advisors Growth Catalyst
                                            <img src="assets/img/icon/category-3.svg" alt="Elevate" />
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/blog">
                                            Financial Advisory Partners
                                            <img src="assets/img/icon/category-4.svg" alt="Elevate" />
                                        </Link>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div className="recent-post-wrap">
                                    <div className="recent-post">
                                        <div className="recent-post-meta">
                                            <Link to="/blog">
                                                <img src="assets/img/icon/calender.svg" alt="Elevate" />
                                                Jan 10, 2024
                                            </Link>
                                        </div>

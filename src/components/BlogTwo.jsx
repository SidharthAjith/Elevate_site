        ...
        <div className="row global-carousel blog-slider slider-shadow">
          <Slider {...settings}>
            <div className="p-3">
              <div className="blog-box">
                <div className="blog-img">
                  <img src="assets/img/blog/blog_s3_1.png" alt="Elevate" />
                </div>
                <div className="blog-content">
                  ...
                  >
                    Read More{" "}
                    <img src="assets/img/icon/right-icon2.svg" alt="Elevate" />
                  </Link>
                </div>
              </div>
            </div>
            <div className="p-3">
              <div className="blog-box">
                <div className="blog-img">
                  <img src="assets/img/blog/blog_s3_2.png" alt="Elevate" />
                </div>
                <div className="blog-content">
                  <div className="blog-meta">
                    <Link to="/blog">
            ...
            <div className="p-3">
              <div className="blog-box">
                <div className="blog-img">
                  <img src="assets/img/blog/blog_s3_3.png" alt="Elevate" />
                </div>
                <div className="blog-content">
                  <div className="blog-meta">
                    <Link to="/blog">
